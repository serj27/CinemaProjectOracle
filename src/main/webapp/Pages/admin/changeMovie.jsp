    ...
    <tr>
        ...
        <td rowspan="200" valign="top" align="center">
            <table width="100%" border="2">
                ...
                <tr><td><center>${movieDTO.title}</center></td><td>${movieDTO.description}</td><td><center><a href="${pageContext.request.contextPath}../deleteMovie.jsp?id=${movieDTO.id}">Удалить</a><br/><a href="${pageContext.request.contextPath}../updateMovie.jsp?id=${movieDTO.id}">Обновить</a></center></td></tr>
            </table>
        </td>
    </tr>
    <tr>
